...
import 'package:ylaevent/modules/forget_password/reset_password/resetPasswordScreen.dart';
import 'package:ylaevent/shared/components/components.dart';



class VerifyNewPassword extends StatelessWidget {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ForgetPasswordCubit,ForgetPasswordStates>(
        listener: (context,State){
          if(State is VerifyNewPasswordSuccessState )
            {
              navigateAndFinish(context, ResetPassword(emailAddress.toString()));
            }
        },
                      ...
                      child: Column(
                        children: [
                          ...
                          basicBottom(text: 'Verfiy', function: () {
                            ...
                            ForgetPasswordCubit.get(context).verifyNewPassword(
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ForgetPasswordCubit.get(context).sendAgain(email: emailAddress.toString());
                                },
                                child: Center(
                                    child: Text(
                                      'Send again',
