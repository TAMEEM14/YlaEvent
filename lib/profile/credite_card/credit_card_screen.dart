                            ...
                            children: <Widget>[
                              ...
                              BlocConsumer<ProfileCubit , ProfileStates>(
                                listener: (context, state) {
                                  if(state is SuccessCreateCreditCardState){
                                ...
                                builder: (context, state) => ConditionalBuilder(
                                  condition: state is! LoadingCreateCreditCardState,
                                  builder: (context) => GestureDetector(
                                    onTap: () {
                                        ProfileCubit.get(context).createCreditCard(
                                            accountNumber: cardNumber.substring(0,4)+cardNumber.substring(5,9),
                                            accountPIN: cvvCode
                                        );
